...
from diffusers.utils.import_utils import is_torch_available, is_torch_npu_available, is_torch_version
...
def fourier_filter(x_in: "torch.Tensor", threshold: int, scale: int) -> "torch.Tensor":
    ...
    return torch.from_numpy(x_filtered).to(device=x_in.device, dtype=x_in.dtype)
